...
- [ ] `[S]` Gamepad support (Phaser Gamepad API), pads join seamlessly
- [ ] `[O]` 3–4 player local matches (player array refactor, HUD for 4, FFA scoring)
...
- [ ] `[S]` Local stats + achievements (wins, streaks, per-element kills)
